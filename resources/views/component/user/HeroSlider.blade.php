...
<script>
    ...
    async function Hero() {
        ...
        res.data['data'].forEach((item,i)=>{
            let activeClass='', style='text-black';
            if(i===0){
                activeClass=' active ' , style='text-danger'
            }
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-9">
                                <div class="banner_content overflow-hidden">
                                    ...
                                    <h2 class="staggered-animation p-2 leads font-weight-bold ${style}" data-animation="slideInLeft " data-animation-delay="1s"    >${item['title']}</h2>
                                    <a class="btn btn-fill-out rounded-0 staggered-animation text-uppercase" href="/user/detailsPage?id=${item['product_id']}" data-animation="slideInLeft" data-animation-delay="1.5s">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div><!-- END CONTAINER-->
