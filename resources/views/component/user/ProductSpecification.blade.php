        ...
        <div class="col-md-12">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="details-tab-pane" role="tabpanel" aria-labelledby="details-tab" tabindex="0">
                   <div class="mb-3 leads"  id="p_details">
                ...
                <div class="tab-pane fade" id="review_create-tab-pane" role="tabpanel" aria-labelledby="review_create-tab" tabindex="0">
                    ...
                    <label class="form-label mt-2">Rating Score(Rate out of 100)</label>
                    <input min="1" placeholder="100" value="0" max="10" id="reviewScore" type="number" class="form-control-sm form-control">
