...
<script>
            ...
            let EachItem=`<div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="#">
                                            <img src="${item['img_url']}" alt="product_img9">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li><a href="/user/detailsPage?id=${item['id']}" class="popup-ajax"><i class="icon-magnifier-add"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="/user/detailsPage?id=${item['id']}">${item['name']}</a></h6>
    ...
    async function Special(){
        let res=await axios.get("/ListProductByRemark/best Seller");
        $("#SpecialItem").empty();
...
//Deleted one Remark here for now
