            ...
            let EachItem=`<div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="#">
                                            <img src="${imgBasePath}${item['product']['img_url']}" alt="product_img9">
                                        </a>
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title"><a href="/details?id=${item['product']['id']}">${item['product']['name']}</a></h6>
                                        <div class="product_price">
                                            <span class="price">BDT ${item['product']['price']}</span>
                                        </div>
